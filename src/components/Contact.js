                    ...
                    <div className="col span-1-of-2 contact-box">
                        <div className="contact-text">
                            <h2>Get in touch!</h2>
                                ...
                                <br /> Reach out via email or LinkedIn. I look forward to working with you! <br /><button className="btn"><a href="mailto:hello@clarkglewis.com" target="_blank" rel="noopener noreferrer">Contact Me!</a></button></p>
