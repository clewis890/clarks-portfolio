    ...
    render() {
        ...
        <h3>I'm a Programmer</h3>
           ...
           <ul className="pics">
               ...
               <li className="pics">
               <img src={boatsandhills} alt="Ocean bay with boats"/>
               </li>
                <li className="pics">
                <img src={bigcity} alt="big city"/>
                </li>
                <li className="pics">
                <img src={ocean} alt="islands in the ocean"/>
                </li>
                <li className="pics">
                <img src={tropical} alt="sunset over mountains"/>
                </li>
                <li className="pics">
                <img src={ldstemple} alt="lds temple Porto Alegre Brazil"/>
                </li>
                <li className="pics">
                <img src={sunset} alt="Sunset over Porto Alegre Brazil"/>
                </li>
                <li className="pics">
                <img src={boatsandhills} alt="Bay with boats"/>
                </li>
                <li className="pics">
